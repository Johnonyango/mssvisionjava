...
public class LandingPageContentImpl implements LandingPageContentController {
    @Inject
...
//                landingPageContents.setAddressString(
//                        new ObjectMapper().writeValueAsString(landingPageContents.getAddress())
//                );
