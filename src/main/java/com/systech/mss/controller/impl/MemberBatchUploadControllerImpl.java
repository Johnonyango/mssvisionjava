...
public class MemberBatchUploadControllerImpl implements MemberBatchUploadController {
    ...
    private Map<String, Object> convertToCSV(Sheet sheet, long mssuserid) throws JsonProcessingException {
        Row row = null;
    ...
    @Override
    public Response uploadFile(long mssuserid, MultipartFormDataInput input) {
    ...
    private Map<String, Object> parseLines(List<List<String>> lines, long userId) throws JsonProcessingException {
        ...
        for (int i = 0; i < lines.size(); i++) {
            ...
            userDTO.setSchemeId(user.getUserDetails().getSchemeId());
            userDTO.setSponsorId(user.getUserDetails().getSponsorId());
