...
public class LandingPageContentRepositoryImpl extends AbstractRepositoryImpl<LandingPageContent, Long> implements LandingPageContentRepository {
    ...
    public LandingPageContent getLandingPageContent() {
        ...
        landingPageContent.getId();
        landingPageContent.getAddress();
        landingPageContent.getCreatedDate();
        landingPageContent.getLogo();
        landingPageContent.getWelcomeMessage();
        landingPageContent.getWhySaveMessage();
        landingPageContent.getPensionerImage();
        landingPageContent.getPensionerMessage();
        landingPageContent.getMemberMessage();
