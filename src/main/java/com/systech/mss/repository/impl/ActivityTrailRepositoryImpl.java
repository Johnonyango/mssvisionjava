            ...
            if (name != null) {
                ...
                if (activityTrails != null) {
                    for (ActivityTrail activityTrail :
                        ...
                        activityTrail.setShortDate(DateUtils.shortDate(activityTrail.getCreatedDate()));
                        activityTrail.setShortDateTime(DateUtils.shortDateTime(activityTrail.getCreatedDate()));
                        activityTrail.setUserName(userService.getUsersFullNameById(mssuserid));
                    }
                    return activityTrails;
                }
...
//                        ActivityTrail activityTrail = new ActivityTrail();
//                        activityTrail.setId(jsonArray.getLong(0));
//                        try {
//                            activityTrail.setCreatedDate(DateUtils.getLocalDateTime(jsonArray.getLong(1)));
...
//                        }
//                        activityTrail.setDescription(jsonArray.getString(2));
//                        activityTrail.setUserId(jsonArray.getLong(3));
//                        activityTrail.setName(jsonArray.getString(4));
//                        activityTrail.setProfile(jsonArray.getString(5));
//
//
//                        activityTrails.add(activityTrail);
//                    }
