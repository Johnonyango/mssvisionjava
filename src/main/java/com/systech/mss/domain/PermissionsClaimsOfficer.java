...
@Entity
@Table(name = PermissionsClaimsOfficer.TB_NAME)
@Getter
@Setter
@NoArgsConstructor
public class PermissionsClaimsOfficer extends BaseModel  implements Serializable {
    @Transient
    public static final String TB_NAME = "claimsofficerperms";
