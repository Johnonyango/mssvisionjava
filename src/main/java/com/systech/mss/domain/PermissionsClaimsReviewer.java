...
@Entity
@Table(name = PermissionsClaimsReviewer.TB_NAME)
@Getter
@Setter
@NoArgsConstructor
public class PermissionsClaimsReviewer extends BaseModel  implements Serializable {
    @Transient
    public static final String TB_NAME = "claimsreviewerperms";
