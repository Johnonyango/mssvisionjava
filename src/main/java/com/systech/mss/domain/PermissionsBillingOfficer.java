...
@Entity
@Table(name = PermissionsBillingOfficer.TB_NAME)
@Getter
@Setter
@NoArgsConstructor
public class PermissionsBillingOfficer extends BaseModel  implements Serializable {

    @Transient
    public static final String TB_NAME = "billingofficerperms";
