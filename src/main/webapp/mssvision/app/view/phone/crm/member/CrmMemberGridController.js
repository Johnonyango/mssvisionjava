Ext.define('MssPhoenix.view.phone.crm.member.CrmMemberGridController', {
    extend: 'MssPhoenix.view.tablet.shared.BaseController',
    alias: 'controller.crmphonemembergridcontroller',
    mixins: [
    ...
    searchMember: function () {
        let win = Ext.ComponentQuery.query('crmphonemembergrid')[0];
        if (win) {
            ...
            if (form) {
                ...
                let grid = Ext.ComponentQuery.query('crmphonemembergrid')[0];
                if (grid) {
