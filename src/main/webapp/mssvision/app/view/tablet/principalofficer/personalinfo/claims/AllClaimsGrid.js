Ext.define('MssPhoenix.view.tablet.principalofficer.personalinfo.claims.AllClaimsGrid', {
    ...
    items: [{
        ...
        items: [
            ...
            {
                xtype: 'formpanel',
                reference: 'filterallclaims',
                itemId: 'filterallclaims',
                layout: {
                    type: 'hbox',
                },
                items: [
                    ...
                    },
                    {
                        ...
                        ui: 'action',
                        handler: 'filterAllClaims'
                    },
                ]
            },
            {
                iconCls: 'fa fa-redo',
                handler: 'reloadAllClaimsGrid',
                ui: 'action'
            },
        ]
    }],
