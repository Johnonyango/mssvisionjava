Ext.define('MssPhoenix.view.tablet.admin.permissions.ClaimsOfficerPermissions', {
    ...
    items: [
        {
            ...
            xtype: 'formpanel',
            reference: 'claimsofficerpermissionsform',
            itemId: 'claimsofficerpermissionsform',
            jsonSubmit: true,
            items: [
                {
                    xtype: 'container',
                            ...
                            items:[
                                {
                                   ...
                                   // id: 'saveSponsorPermsBtn',
                                    handler: 'saveClaimsOfficerPerms'
                                },
                                {width:50},
                                {
                                    xtype: 'button',
                                    ...
                                    ui: 'action',
                                   // id: 'setSponDefBtn',
                                    handler: 'setDefaultsClaimsOfficer'
                                },
                            ]
                        }
                    ]
