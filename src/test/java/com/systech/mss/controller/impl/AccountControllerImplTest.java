...
public class AccountControllerImplTest {
    ...
    public void testRegisterAccount() {
        ...
        final MemberDTO memberDTO = new MemberDTO("mbshipStatus", "nationalPenNo", "pensionerId", false, "profile", 0L, 0L, "name", 0L, "sponsorRefNo", "email", "cellPhone", "message", "staffNo", "accountStatus", 0L);
